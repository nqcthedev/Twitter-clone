...
import {
  ...
  ForgotRequestReqBody,
  GetProfileReqProfileParams,
  LoginReqBody,
  LogoutReqBody,
  RefreshTokenBody,
  RegisterReqBody,
...
export const verifyEmailController = async (
  ...
  // Mà mình sẽ trả về status OK với những message là đã verify trước đó rồi

  if (user.email_verify_token === '') {
    return res.json({ message: USERS_MESSAGES.EMAIL_ALREADY_VERIFIED_BEFORE });
  }

  // Nếu chưa verify thì mình sẽ gán user vào req.user để sử dụng ở controller
...
export const forgotPasswordController = async (
  req: Request<ParamsDictionary, any, ForgotRequestReqBody>,
  res: Response,
  next: NextFunction
) => {
...
export const getProfileController = async (
  req: Request<GetProfileReqProfileParams>,
  res: Response,
  next: NextFunction
) => {
